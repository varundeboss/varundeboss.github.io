...
var apigImageClientFactory = {};
apigImageClientFactory.newClient = function (config) {
    var apigClient = { };
    if(config === undefined) {
        config = {
            accessKey: '',
    ...
    var invokeUrl = 'https://5sa4tjapxh.execute-api.ap-southeast-1.amazonaws.com/production';
